...
public enum EventType {
    ...
    /**
     * Returns the {@link EventType} that has the same name as the given string.
     * All underlines get dropped and the name is not case sensitive. If no
     * fitting EventType value was found, the method returns <code>null</code>.
     *
