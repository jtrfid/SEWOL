...
public class LogEntry implements Comparable<LogEntry>, Cloneable {
        ...
        /**
         * The originator of the log entry (the person/process responsible for
         * it).
         */
         ...
         */
        protected final Set<DataAttribute> metaData = new HashSet<>();
        /**
         * Stores the locked fields of the log entry together with the locking
         * reason.<br>
         * Locked fields cannot be altered any more.
         */
        private final Map<EntryField, String> locking = new HashMap<>();
        /**
         * Random generator.
         */
        protected final static Random rand = new Random();
        /**
         * Field that allows to group log traces together by assigning them the
         * same group.<br>
         * Can be useful when different event types for an activity are used
         * (start, suspend, complete). Group assignment in this case allows to
         * reflect togetherness.
         */
    ...
    //MBiManrX, synology.iig.uni-freiburg.de/Name/trunk
         ...
         * @throws LockingException if the field ACTIVITY is locked and the
         * given activity differs from the current value of {@link #activity}.
         ...
         * @throws LockingException if the originator field is locked <br>and
         * the given value differs from the actual value of {@link #originator}.
         ...
         * @throws ParameterException if the given value is <code>null</code>.
         * @throws LockingException if the role field is locked <br>and the
         * given value differs from the actual value of {@link #role}.
