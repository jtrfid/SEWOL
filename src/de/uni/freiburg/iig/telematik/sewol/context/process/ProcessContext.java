...
public class ProcessContext extends SOABase implements SOABaseListener {
    ...
    /**
     * Data usage (read, write, ...) for attributes which are used in process
     * activities.
     */
...
//	}
     ...
     * This method checks, if the access control model is compatible with the
     * log context, i.e. is contains all subjects and activities of the log
     * context.
     *
     ...
     * contained in the activity/attribute list.
     *
     ...
     * @throws IllegalArgumentException If the given activity/attributes are not
     * known.
    ...
    /**
     * Sets the data attributes used by the given activity together with their
     * usage.<br>
     * The given activity/attributes have to be known by the context, i.e. be
     * contained in the activity/attribute list.
     *
     ...
     * The given activity/attributes have to be known by the context, i.e. be
     * contained in the activity/attribute list.<br>
     ...
     * @throws ParameterException
     * @throws CompatibilityException
     * @throws IllegalArgumentException IllegalArgumentException If the given
     * activity/attributes are not known.
     * @see #getActivities()
     * @see #getAttributes()
     * @see #setAttributes(Set)
     */
     ...
     * usage.<br>
     * The given activities/attributes have to be known by the context, i.e. be
     * contained in the activity/attribute list.
     *
     ...
     * @throws ParameterException
     * @throws IllegalArgumentException IllegalArgumentException If the given
     * activities/attributes are not known.
     * @see #getActivities()
     * @see #getAttributes()
     * @see #setAttributes(Set)
     */
     ...
     * If the given attribute is not used as input by the given activity, the
     * returned set contains no elements. The given activity/attribute have to
     * be known by the context, i.e. be contained in the activity/attribute
     * list.
     *
     ...
     * @throws CompatibilityException
     * @throws IllegalArgumentException IllegalArgumentException If the given
     * activity/attribute is not known.
     * @see #getActivities()
     * @see #getAttributes()
     */
     ...
     * usage.<br>
     * If the given attribute has no attributes, the returned set contains no
     * elements.<br>
     * The given activity has to be known by the context, i.e. be contained in
     * the activity list.
     *
     ...
     * If the given attribute has no attributes, the returned set contains no
     * elements. The given activity has to be known by the context, i.e. be
     * contained in the activity list.
     *
     ...
     * activity.<br>
     * A subject is authorized for execution, if it is authorized to execute the
     * activity itself,<br>
     ...
     * @return <code>true</code> if the given subject is authorized to execute
     * the given activity;<br>
    ...
    /**
     * Checks if the given activity is executable, i.e. there is at least one
     * subject which is authorized to execute it.<br>
     * This method delegates the call to the access control model.
     *
    ...
    /**
     * Checks if the given attributes are known, i.e. they are all contained in
     * the attribute list.
     *
